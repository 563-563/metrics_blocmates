...
**Generated:** 2026-05-28T00:17:19.270Z
**As-of:** 2026-05-28
**Mode:** live
...
| Aave (AAVE) | `current` | $1.22B | $11.13M/yr | **110.0×** | speculative |
| Hyperliquid (HYPE) | `current` | $28.44B | $430.16M/yr | **66.1×** | speculative |
| Lighter (LIT) | `current` | $495.80M | $24.87M/yr | **19.9×** | strong |
...
| 2 | Current float market cap | $1.53B | 23,243,770,283 SKY × $0.066039 (circ source: live) |
...
### Aave (AAVE) — HM 110.0× _(speculative)_

Phase: `current` — ARFC $30M/yr buyback budget (cut from original $50M). AWW Framework commits 100% product revenue to DAO.

| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $83.05 | source: live |
| 2 | Current float market cap | $1.26B | 15,179,912 AAVE × $83.05 (circ source: live) |
| 3 | + 24mo unlocks | $0 | No team vesting; 99.9% circulating |
| 4 | + 24mo emissions | +$23.67M | Safety Module + Service Provider compensation (285K AAVE over 24mo) |
...
| 10 | **Holder Multiple (HM)** | **110.0×** | Line 6 ÷ Line 9 |
...
### Hyperliquid (HYPE) — HM 66.1× _(speculative)_

Phase: `current` — Assistance Fund captures ~99% of revenue for HYPE buybacks. Team vesting cliff active.

| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $57.78 | source: live |
| 2 | Current float market cap | $17.26B | 298,649,468 HYPE × $57.78 (circ source: onchain_feed) |
| 3 | + 24mo unlocks | +$12.04B | Y1 119M + Y2 89.3M team unlocks (Tokenomist scheduled rate) |
| 4 | + 24mo emissions | +$392.90M | Staking emissions paid from Future Emissions allocation (Category C — added to dilution side) |
...
| 6 | **Adjusted MCap** | **$28.44B** | Lines 2 + 3 + 4 − 5 |
| 7 | Annual buyback (Category A) | $430.16M | last 60d annualized — verification: onchain |
...
| 9 | **Total Real Capture** | **$430.16M/yr** | Lines 7 + 8 |
| 10 | **Holder Multiple (HM)** | **66.1×** | Line 6 ÷ Line 9 |

**Buyback rate lens:** recent 60d annualized = **$430.16M/yr** (HM input). Lifetime annualized (434d, cumulative $902.83M) = **$759.29M/yr**. Recent rate is **-43.3%** below lifetime average.

[Sources: DefiLlama, Hyperliquid Info API, Tokenomist, Hyperliquid docs]

---

### Lighter (LIT) — HM 19.9× _(strong)_
...
| 7 | Annual buyback (Category A) | $24.87M | last 60d annualized — verification: onchain |
...
| 9 | **Total Real Capture** | **$24.87M/yr** | Lines 7 + 8 |
| 10 | **Holder Multiple (HM)** | **19.9×** | Line 6 ÷ Line 9 |

**Buyback rate lens:** recent 60d annualized = **$24.87M/yr** (HM input). Lifetime annualized (142d, cumulative $18.48M) = **$47.51M/yr**. Recent rate is **-47.7%** below lifetime average.
