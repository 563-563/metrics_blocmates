...
**Generated:** 2026-05-29T12:29:49.092Z
**As-of:** 2026-05-29
**Mode:** live
...
| Aave (AAVE) | `current` | $1.20B | $10.62M/yr | **113.0×** | speculative |
| Hyperliquid (HYPE) | `current` | $30.57B | $429.22M/yr | **71.2×** | speculative |
...
| 2 | Current float market cap | $1.53B | 23,242,949,521 SKY × $0.065873 (circ source: live) |
...
### Aave (AAVE) — HM 113.0× _(speculative)_

Phase: `current` — ARFC $30M/yr buyback budget (cut from original $50M). AWW Framework commits 100% product revenue to DAO.

| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $81.52 | source: live |
| 2 | Current float market cap | $1.24B | 15,179,912 AAVE × $81.52 (circ source: live) |
| 3 | + 24mo unlocks | $0 | No team vesting; 99.9% circulating |
| 4 | + 24mo emissions | +$23.23M | Safety Module + Service Provider compensation (285K AAVE over 24mo) |
...
| 7 | Annual buyback (Category A) | $429.22M | last 60d annualized — verification: onchain |
...
| 9 | **Total Real Capture** | **$429.22M/yr** | Lines 7 + 8 |
| 10 | **Holder Multiple (HM)** | **71.2×** | Line 6 ÷ Line 9 |

**Buyback rate lens:** recent 60d annualized = **$429.22M/yr** (HM input). Lifetime annualized (435d, cumulative $903.37M) = **$758.00M/yr**. Recent rate is **-43.4%** below lifetime average.
