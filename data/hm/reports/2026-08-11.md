...
**Generated:** 2026-08-11T02:33:47.784Z
**As-of:** 2026-08-11
**Mode:** live
...
| Maple Finance (SYRUP) | `none` | $188.01M | $0/yr | **∞×** | no real capture |
| Hyperliquid (HYPE) | `current` | $27.13B | $91.17M/yr | **297.6×** | speculative |
| Uniswap (UNI) | `executing` | $2.47B | $62.76M/yr | **39.4×** | expensive |
| Sky (SKY) | `phase_1` | $1.24B | $0/yr | **∞×** | no real capture |
| Ethena (ENA) | `none` | $894.41M | $0/yr | **∞×** | no real capture |
| Meteora (MET) | `proposed` | $85.78M | $0/yr | **∞×** | no real capture |
| Raydium (RAY) | `executing` | $170.53M | $7.01M/yr | **24.3×** | fair value |
| Jito (JTO) | `paused` | $279.81M | $0/yr | **∞×** | no real capture |
| Aerodrome (AERO) | `executing` | $406.16M | $116.79M/yr | **3.5×** | exceptional |
| Sanctum (CLOUD) | `none` | $12.86M | $0/yr | **∞×** | no real capture |
| Kamino (KMNO) | `none` | $95.04M | $0/yr | **∞×** | no real capture |
...
| Collector Crypt (CARDS) | `executing` | $295.19M | $68.32M/yr | **4.3×** | exceptional |
| Drift (DRIFT) | `none` | $0 | $0/yr | **∞×** | no real capture |
| Dolomite (DOLO) | `executing` | $12.16M | $0/yr | **∞×** | no real capture |
| Pendle (PENDLE) | `executing` | $234.03M | $7.25M/yr | **32.3×** | fair value |
| Lido DAO (LDO) | `conditional` | $249.09M | $0/yr | **∞×** | no real capture |
| GMX (GMX) | `paused` | $66.16M | $0/yr | **∞×** | no real capture |
| dYdX (DYDX) | `executing` | $97.29M | $2.58M/yr | **37.7×** | expensive |
| Gains Network (GNS) | `executing` | $12.64M | $1.08M/yr | **11.7×** | strong |
| ether.fi (ETHFI) | `executing` | $381.36M | $5.10M/yr | **74.8×** | speculative |
| Curve Finance (CRV) | `executing` | $415.04M | $7.27M/yr | **57.1×** | speculative |
| Orca (ORCA) | `executing` | $64.39M | $587.53K/yr | **109.6×** | speculative |
| CoW Protocol (COW) | `executing` | $60.29M | $8.30M/yr | **7.3×** | exceptional |
| LayerZero (ZRO) | `executing` | $304.16M | $1.58M/yr | **192.6×** | speculative |
| Synthetix (SNX) | `unverified` | $123.49M | $0/yr | **∞×** | no real capture |
| Usual Money (USUAL) | `executing` | $17.21M | $11.96M/yr | **1.4×** | exceptional |
| pump.fun (PUMP) | `executing` | $1.10B | $208.95M/yr | **5.3×** | exceptional |
| Rollbit (RLB) | `executing` | $110.57M | $0/yr | **∞×** | no real capture |
| Jupiter Exchange (JUP) | `executing` | $605.14M | $22.48M/yr | **26.9×** | fair value |
| Marinade Finance (MNDE) | `executing` | $10.28M | $0/yr | **∞×** | no real capture |
| Lighter (LIT) | `current` | $1.13B | $24.09M/yr | **46.9×** | expensive |
...
| 2 | Current float market cap | $1.28B | 656,175,635 MORPHO × $1.95 (circ source: live) |
...
| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $89.18 | source: live |
| 2 | Current float market cap | $1.38B | 15,422,576 AAVE × $89.18 (circ source: live) |
...
| 2 | Current float market cap | $188.01M | 1,244,677,493 SYRUP × $0.151052 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: governance_stated) |
| 6 | **Adjusted MCap** | **$188.01M** | Lines 2 + 3 + 4 − 5 |
| 7 | Annual buyback (Category A) | $0 | verification: governance_stated |
...
### Hyperliquid (HYPE) — HM 297.6× _(speculative)_

Phase: `current` — Assistance Fund captures ~99% of revenue for HYPE buybacks. Team vesting cliff active.

| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $55.23 | source: live |
| 2 | Current float market cap | $16.49B | 298,649,468 HYPE × $55.23 (circ source: onchain_feed) |
| 3 | + 24mo unlocks | +$11.50B | Y1 119M + Y2 89.3M team unlocks (Tokenomist scheduled rate) |
| 4 | + 24mo emissions | +$375.56M | Staking emissions paid from Future Emissions allocation (Category C — added to dilution side) |
...
| 6 | **Adjusted MCap** | **$27.13B** | Lines 2 + 3 + 4 − 5 |
| 7 | Annual buyback (Category A) | $91.17M | last 60d annualized — verification: onchain |
...
| 9 | **Total Real Capture** | **$91.17M/yr** | Lines 7 + 8 |
| 10 | **Holder Multiple (HM)** | **297.6×** | Line 6 ÷ Line 9 |

**Buyback rate lens:** recent 60d annualized = **$91.17M/yr** (HM input). Lifetime annualized (509d, cumulative $919.03M) = **$659.03M/yr**. Recent rate is **-86.2%** below lifetime average.

[Sources: DefiLlama, Hyperliquid Info API, Tokenomist, Hyperliquid docs]

---

### Uniswap (UNI) — HM 39.4× _(expensive)_
...
| 2 | Current float market cap | $2.47B | 624,348,424 UNI × $3.96 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 2 | Current float market cap | $1.24B | 23,411,730,332 SKY × $0.052855 (circ source: live) |
...
| 2 | Current float market cap | $894.41M | 9,828,125,000 ENA × $0.091005 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: governance_stated) |
| 6 | **Adjusted MCap** | **$894.41M** | Lines 2 + 3 + 4 − 5 |
| 7 | Annual buyback (Category A) | $0 | verification: governance_stated |
...
| 2 | Current float market cap | $85.78M | 543,548,924 MET × $0.157818 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: governance_stated) |
...
| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $0.6328 | source: live |
| 2 | Current float market cap | $170.53M | 269,513,825 RAY × $0.63275 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 6 | **Adjusted MCap** | **$170.53M** | Lines 2 + 3 + 4 − 5 |
...
| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $0.55 | source: live |
| 2 | Current float market cap | $279.81M | 508,737,352 JTO × $0.550011 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 6 | **Adjusted MCap** | **$279.81M** | Lines 2 + 3 + 4 − 5 |
...
| 2 | Current float market cap | $406.16M | 973,094,779 AERO × $0.417385 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 2 | Current float market cap | $12.86M | 599,013,117 CLOUD × $0.02146063 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: governance_stated) |
...
| 2 | Current float market cap | $95.04M | 5,268,493,466 KMNO × $0.01804001 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: governance_stated) |
...
| 2 | Current float market cap | $1.66B | 4,869,330,647 ONDO × $0.341101 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: governance_stated) |
...
| 2 | Current float market cap | $295.19M | 1,999,705,628 CARDS × $0.147619 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 6 | **Adjusted MCap** | **$295.19M** | Lines 2 + 3 + 4 − 5 |
...
| 2 | Current float market cap | $0 | 0 DRIFT × $0.01164835 (circ source: seed_fallback) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: governance_stated) |
...
| 2 | Current float market cap | $12.16M | 509,723,226 DOLO × $0.02384933 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: proxy) |
...
| 2 | Current float market cap | $234.03M | 172,080,178 PENDLE × $1.36 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: proxy) |
...
| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $0.2978 | source: live |
| 2 | Current float market cap | $249.09M | 836,305,815 LDO × $0.297842 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 6 | **Adjusted MCap** | **$249.09M** | Lines 2 + 3 + 4 − 5 |
| 7 | Annual buyback (Category A) | $0 | verification: governance_stated |
...
| 2 | Current float market cap | $66.16M | 10,451,920 GMX × $6.33 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $0.1147 | source: live |
| 2 | Current float market cap | $97.29M | 848,599,091 DYDX × $0.114653 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 6 | **Adjusted MCap** | **$97.29M** | Lines 2 + 3 + 4 − 5 |
...
| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $0.5303 | source: live |
| 2 | Current float market cap | $12.64M | 23,839,587 GNS × $0.530278 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $0.3918 | source: live |
| 2 | Current float market cap | $381.36M | 973,468,000 ETHFI × $0.391756 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 6 | **Adjusted MCap** | **$381.36M** | Lines 2 + 3 + 4 − 5 |
...
| 2 | Current float market cap | $415.04M | 1,546,605,417 CRV × $0.268353 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: proxy) |
| 6 | **Adjusted MCap** | **$415.04M** | Lines 2 + 3 + 4 − 5 |
| 7 | Annual buyback (Category A) | $0 | verification: proxy |
...
### Orca (ORCA) — HM 109.6× _(speculative)_
...
| 2 | Current float market cap | $64.39M | 60,798,778 ORCA × $1.059 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $0.1048 | source: live |
| 2 | Current float market cap | $60.29M | 575,229,467 COW × $0.104812 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 6 | **Adjusted MCap** | **$60.29M** | Lines 2 + 3 + 4 − 5 |
...
### LayerZero (ZRO) — HM 192.6× _(speculative)_
...
| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $0.8609 | source: live |
| 2 | Current float market cap | $304.16M | 353,313,326 ZRO × $0.860873 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 6 | **Adjusted MCap** | **$304.16M** | Lines 2 + 3 + 4 − 5 |
...
| 10 | **Holder Multiple (HM)** | **192.6×** | Line 6 ÷ Line 9 |
...
| 2 | Current float market cap | $123.49M | 580,980,590 SNX × $0.212549 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 6 | **Adjusted MCap** | **$123.49M** | Lines 2 + 3 + 4 − 5 |
| 7 | Annual buyback (Category A) | $0 | verification: governance_stated |
...
| 2 | Current float market cap | $17.21M | 1,858,355,554 USUAL × $0.0092621 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: proxy) |
| 6 | **Adjusted MCap** | **$17.21M** | Lines 2 + 3 + 4 − 5 |
| 7 | Annual buyback (Category A) | $0 | verification: proxy |
...
| 2 | Current float market cap | $1.10B | 393,353,915,910 PUMP × $0.00279842 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 2 | Current float market cap | $110.57M | 1,598,356,843 RLB × $0.069179 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 2 | Current float market cap | $605.14M | 3,320,312,968 JUP × $0.182254 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 6 | **Adjusted MCap** | **$605.14M** | Lines 2 + 3 + 4 − 5 |
...
| 2 | Current float market cap | $10.28M | 546,399,977 MNDE × $0.01881641 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
### Lighter (LIT) — HM 46.9× _(expensive)_
...
| 2 | Current float market cap | $605.00M | 250,000,000 LIT × $2.42 (circ source: live) |
| 3 | + 24mo unlocks | +$522.72M | 54M Y1 + 162M Y2; cliff Dec 22 2026 unlocks 13.5M/mo across 36mo linear |
| 4 | + 24mo emissions | +$53.89M | Staking emissions over 24mo (Category C) |
