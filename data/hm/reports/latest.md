...
**Generated:** 2026-05-26T20:47:05.041Z
**As-of:** 2026-05-26
**Mode:** live
...
| Aave (AAVE) | `current` | $1.28B | $12.15M/yr | **105.0×** | speculative |
| Hyperliquid (HYPE) | `current` | $29.61B | $430.63M/yr | **68.8×** | speculative |
| Lighter (LIT) | `current` | $539.75M | $25.16M/yr | **21.5×** | fair value |
...
| 2 | Current float market cap | $1.61B | 23,244,470,147 SKY × $0.069422 (circ source: live) |
...
### Aave (AAVE) — HM 105.0× _(speculative)_

Phase: `current` — ARFC $30M/yr buyback budget (cut from original $50M). AWW Framework commits 100% product revenue to DAO.

| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $86.43 | source: live |
| 2 | Current float market cap | $1.31B | 15,179,912 AAVE × $86.43 (circ source: live) |
| 3 | + 24mo unlocks | $0 | No team vesting; 99.9% circulating |
| 4 | + 24mo emissions | +$24.63M | Safety Module + Service Provider compensation (285K AAVE over 24mo) |
...
| 10 | **Holder Multiple (HM)** | **105.0×** | Line 6 ÷ Line 9 |
...
### Hyperliquid (HYPE) — HM 68.8× _(speculative)_

Phase: `current` — Assistance Fund captures ~99% of revenue for HYPE buybacks. Team vesting cliff active.

| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $60.05 | source: live |
| 2 | Current float market cap | $17.93B | 298,649,468 HYPE × $60.05 (circ source: onchain_feed) |
| 3 | + 24mo unlocks | +$12.51B | Y1 119M + Y2 89.3M team unlocks (Tokenomist scheduled rate) |
| 4 | + 24mo emissions | +$408.34M | Staking emissions paid from Future Emissions allocation (Category C — added to dilution side) |
...
| 6 | **Adjusted MCap** | **$29.61B** | Lines 2 + 3 + 4 − 5 |
| 7 | Annual buyback (Category A) | $430.63M | last 60d annualized — verification: onchain |
...
| 9 | **Total Real Capture** | **$430.63M/yr** | Lines 7 + 8 |
| 10 | **Holder Multiple (HM)** | **68.8×** | Line 6 ÷ Line 9 |

**Buyback rate lens:** recent 60d annualized = **$430.63M/yr** (HM input). Lifetime annualized (432d, cumulative $900.93M) = **$761.20M/yr**. Recent rate is **-43.4%** below lifetime average.

[Sources: DefiLlama, Hyperliquid Info API, Tokenomist, Hyperliquid docs]

---

### Lighter (LIT) — HM 21.5× _(fair value)_
...
| 7 | Annual buyback (Category A) | $25.16M | last 60d annualized — verification: onchain |
...
| 9 | **Total Real Capture** | **$25.16M/yr** | Lines 7 + 8 |
| 10 | **Holder Multiple (HM)** | **21.5×** | Line 6 ÷ Line 9 |

**Buyback rate lens:** recent 60d annualized = **$25.16M/yr** (HM input). Lifetime annualized (141d, cumulative $18.40M) = **$47.63M/yr**. Recent rate is **-47.2%** below lifetime average.
