...
**Generated:** 2026-08-11T05:22:56.061Z
**As-of:** 2026-08-11
**Mode:** live
...
| Maple Finance (SYRUP) | `none` | $186.72M | $0/yr | **∞×** | no real capture |
| Hyperliquid (HYPE) | `current` | $27.22B | $90.83M/yr | **299.7×** | speculative |
| Uniswap (UNI) | `executing` | $2.49B | $62.76M/yr | **39.7×** | expensive |
| Sky (SKY) | `phase_1` | $1.22B | $0/yr | **∞×** | no real capture |
| Ethena (ENA) | `none` | $886.42M | $0/yr | **∞×** | no real capture |
| Meteora (MET) | `proposed` | $85.69M | $0/yr | **∞×** | no real capture |
| Raydium (RAY) | `executing` | $169.64M | $7.01M/yr | **24.2×** | fair value |
| Jito (JTO) | `paused` | $280.24M | $0/yr | **∞×** | no real capture |
| Aerodrome (AERO) | `executing` | $406.18M | $116.79M/yr | **3.5×** | exceptional |
| Sanctum (CLOUD) | `none` | $12.84M | $0/yr | **∞×** | no real capture |
| Kamino (KMNO) | `none` | $94.66M | $0/yr | **∞×** | no real capture |
| Ondo Finance (ONDO) | `proposed` | $1.65B | $0/yr | **∞×** | no real capture |
| Fluid (FLUID) | `executing` | $100.44M | $4.75M/yr | **21.2×** | fair value |
| Euler (EUL) | `executing` | $33.16M | $2.30M/yr | **14.4×** | strong |
| Collector Crypt (CARDS) | `executing` | $295.56M | $68.32M/yr | **4.3×** | exceptional |
...
| Lido DAO (LDO) | `conditional` | $248.82M | $0/yr | **∞×** | no real capture |
| GMX (GMX) | `paused` | $66.89M | $0/yr | **∞×** | no real capture |
| dYdX (DYDX) | `executing` | $97.91M | $2.58M/yr | **38.0×** | expensive |
| Gains Network (GNS) | `executing` | $12.66M | $1.08M/yr | **11.7×** | strong |
| ether.fi (ETHFI) | `executing` | $380.72M | $5.10M/yr | **74.7×** | speculative |
| Curve Finance (CRV) | `executing` | $414.94M | $7.27M/yr | **57.1×** | speculative |
| Orca (ORCA) | `executing` | $64.57M | $587.53K/yr | **109.9×** | speculative |
| CoW Protocol (COW) | `executing` | $60.76M | $8.30M/yr | **7.3×** | exceptional |
| LayerZero (ZRO) | `executing` | $300.86M | $1.58M/yr | **190.5×** | speculative |
| Synthetix (SNX) | `unverified` | $123.50M | $0/yr | **∞×** | no real capture |
| Usual Money (USUAL) | `executing` | $16.75M | $11.96M/yr | **1.4×** | exceptional |
| pump.fun (PUMP) | `executing` | $1.10B | $208.95M/yr | **5.3×** | exceptional |
| Rollbit (RLB) | `executing` | $111.01M | $0/yr | **∞×** | no real capture |
| Jupiter Exchange (JUP) | `executing` | $605.20M | $22.48M/yr | **26.9×** | fair value |
...
| 2 | Current float market cap | $1.28B | 656,182,592 MORPHO × $1.95 (circ source: live) |
...
| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $88.94 | source: live |
| 2 | Current float market cap | $1.37B | 15,422,577 AAVE × $88.94 (circ source: live) |
...
| 2 | Current float market cap | $186.72M | 1,244,677,493 SYRUP × $0.150012 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: governance_stated) |
| 6 | **Adjusted MCap** | **$186.72M** | Lines 2 + 3 + 4 − 5 |
| 7 | Annual buyback (Category A) | $0 | verification: governance_stated |
...
### Hyperliquid (HYPE) — HM 299.7× _(speculative)_

Phase: `current` — Assistance Fund captures ~99% of revenue for HYPE buybacks. Team vesting cliff active.

| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $55.4 | source: live |
| 2 | Current float market cap | $16.55B | 298,649,468 HYPE × $55.4 (circ source: onchain_feed) |
| 3 | + 24mo unlocks | +$11.54B | Y1 119M + Y2 89.3M team unlocks (Tokenomist scheduled rate) |
| 4 | + 24mo emissions | +$376.72M | Staking emissions paid from Future Emissions allocation (Category C — added to dilution side) |
...
| 6 | **Adjusted MCap** | **$27.22B** | Lines 2 + 3 + 4 − 5 |
| 7 | Annual buyback (Category A) | $90.83M | last 60d annualized — verification: onchain |
...
| 9 | **Total Real Capture** | **$90.83M/yr** | Lines 7 + 8 |
| 10 | **Holder Multiple (HM)** | **299.7×** | Line 6 ÷ Line 9 |

**Buyback rate lens:** recent 60d annualized = **$90.83M/yr** (HM input). Lifetime annualized (509d, cumulative $918.97M) = **$658.99M/yr**. Recent rate is **-86.2%** below lifetime average.
...
| 2 | Current float market cap | $2.49B | 624,348,424 UNI × $3.99 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $0.0522 | source: live |
| 2 | Current float market cap | $1.22B | 23,411,617,293 SKY × $0.052173 (circ source: live) |
...
| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $0.0902 | source: live |
| 2 | Current float market cap | $886.42M | 9,828,125,000 ENA × $0.090192 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: governance_stated) |
| 6 | **Adjusted MCap** | **$886.42M** | Lines 2 + 3 + 4 − 5 |
| 7 | Annual buyback (Category A) | $0 | verification: governance_stated |
...
| 2 | Current float market cap | $85.69M | 543,713,307 MET × $0.157602 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: governance_stated) |
...
| 2 | Current float market cap | $169.64M | 269,513,825 RAY × $0.629431 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 6 | **Adjusted MCap** | **$169.64M** | Lines 2 + 3 + 4 − 5 |
...
| 2 | Current float market cap | $280.24M | 508,737,245 JTO × $0.550851 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 2 | Current float market cap | $406.18M | 973,092,385 AERO × $0.417411 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: proxy) |
| 6 | **Adjusted MCap** | **$406.18M** | Lines 2 + 3 + 4 − 5 |
...
| 2 | Current float market cap | $12.84M | 599,013,117 CLOUD × $0.02143457 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: governance_stated) |
...
| 2 | Current float market cap | $94.66M | 5,268,493,466 KMNO × $0.01796773 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: governance_stated) |
...
| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $0.3392 | source: live |
| 2 | Current float market cap | $1.65B | 4,869,330,647 ONDO × $0.339203 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: governance_stated) |
...
| 2 | Current float market cap | $33.16M | 27,182,818 EUL × $1.22 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $0.1478 | source: live |
| 2 | Current float market cap | $295.56M | 1,999,705,628 CARDS × $0.147801 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 6 | **Adjusted MCap** | **$295.56M** | Lines 2 + 3 + 4 − 5 |
...
| 2 | Current float market cap | $0 | 0 DRIFT × $0.01181156 (circ source: seed_fallback) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: governance_stated) |
...
| 2 | Current float market cap | $12.26M | 509,723,226 DOLO × $0.02405763 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: proxy) |
...
| 2 | Current float market cap | $232.31M | 172,080,283 PENDLE × $1.35 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: proxy) |
...
| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $0.2975 | source: live |
| 2 | Current float market cap | $248.82M | 836,305,815 LDO × $0.297518 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 6 | **Adjusted MCap** | **$248.82M** | Lines 2 + 3 + 4 − 5 |
| 7 | Annual buyback (Category A) | $0 | verification: governance_stated |
...
| 2 | Current float market cap | $66.89M | 10,451,920 GMX × $6.4 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 2 | Current float market cap | $97.91M | 848,599,091 DYDX × $0.115382 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $0.5309 | source: live |
| 2 | Current float market cap | $12.66M | 23,839,587 GNS × $0.530928 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $0.3911 | source: live |
| 2 | Current float market cap | $380.72M | 973,468,000 ETHFI × $0.391097 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
### Curve Finance (CRV) — HM 57.1× _(speculative)_
...
| 2 | Current float market cap | $414.94M | 1,546,787,253 CRV × $0.26826 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: proxy) |
| 6 | **Adjusted MCap** | **$414.94M** | Lines 2 + 3 + 4 − 5 |
| 7 | Annual buyback (Category A) | $0 | verification: proxy |
...
| 2 | Current float market cap | $64.57M | 60,798,778 ORCA × $1.062 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 6 | **Adjusted MCap** | **$64.57M** | Lines 2 + 3 + 4 − 5 |
...
| 2 | Current float market cap | $60.76M | 575,229,467 COW × $0.105635 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 6 | **Adjusted MCap** | **$60.76M** | Lines 2 + 3 + 4 − 5 |
...
### LayerZero (ZRO) — HM 190.5× _(speculative)_
...
| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $0.8516 | source: live |
| 2 | Current float market cap | $300.86M | 353,313,326 ZRO × $0.85155 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 6 | **Adjusted MCap** | **$300.86M** | Lines 2 + 3 + 4 − 5 |
...
| 10 | **Holder Multiple (HM)** | **190.5×** | Line 6 ÷ Line 9 |
...
| 2 | Current float market cap | $123.50M | 580,980,590 SNX × $0.212571 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 6 | **Adjusted MCap** | **$123.50M** | Lines 2 + 3 + 4 − 5 |
| 7 | Annual buyback (Category A) | $0 | verification: governance_stated |
...
| 2 | Current float market cap | $16.75M | 1,858,355,554 USUAL × $0.00901568 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: proxy) |
...
| 2 | Current float market cap | $1.10B | 393,321,304,091 PUMP × $0.0028 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 2 | Current float market cap | $111.01M | 1,598,317,943 RLB × $0.069452 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 6 | **Adjusted MCap** | **$111.01M** | Lines 2 + 3 + 4 − 5 |
| 7 | Annual buyback (Category A) | $0 | verification: proxy |
...
| 2 | Current float market cap | $605.20M | 3,320,312,968 JUP × $0.182271 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 6 | **Adjusted MCap** | **$605.20M** | Lines 2 + 3 + 4 − 5 |
...
| 2 | Current float market cap | $10.29M | 546,399,977 MNDE × $0.01883995 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
