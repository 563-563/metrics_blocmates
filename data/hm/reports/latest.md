...
**Generated:** 2026-08-10T05:43:31.193Z
**As-of:** 2026-08-10
**Mode:** live
...
| Maple Finance (SYRUP) | `none` | $188.08M | $0/yr | **∞×** | no real capture |
| Hyperliquid (HYPE) | `current` | $26.58B | $92.13M/yr | **288.5×** | speculative |
| Uniswap (UNI) | `executing` | $2.54B | $60.88M/yr | **41.7×** | expensive |
| Sky (SKY) | `phase_1` | $1.24B | $0/yr | **∞×** | no real capture |
| Ethena (ENA) | `none` | $870.79M | $0/yr | **∞×** | no real capture |
| Meteora (MET) | `proposed` | $87.87M | $0/yr | **∞×** | no real capture |
| Raydium (RAY) | `executing` | $170.84M | $6.55M/yr | **26.1×** | fair value |
| Jito (JTO) | `paused` | $279.39M | $0/yr | **∞×** | no real capture |
| Aerodrome (AERO) | `executing` | $407.50M | $117.18M/yr | **3.5×** | exceptional |
| Sanctum (CLOUD) | `none` | $12.86M | $0/yr | **∞×** | no real capture |
| Kamino (KMNO) | `none` | $94.83M | $0/yr | **∞×** | no real capture |
...
| Collector Crypt (CARDS) | `executing` | $266.64M | $68.03M/yr | **3.9×** | exceptional |
| Drift (DRIFT) | `none` | $0 | $0/yr | **∞×** | no real capture |
| Dolomite (DOLO) | `executing` | $12.63M | $0/yr | **∞×** | no real capture |
| Pendle (PENDLE) | `executing` | $235.75M | $5.23M/yr | **45.1×** | expensive |
| Lido DAO (LDO) | `conditional` | $245.88M | $0/yr | **∞×** | no real capture |
| GMX (GMX) | `paused` | $66.16M | $0/yr | **∞×** | no real capture |
| dYdX (DYDX) | `executing` | $97.64M | $2.50M/yr | **39.1×** | expensive |
| Gains Network (GNS) | `executing` | $12.61M | $1.05M/yr | **12.0×** | strong |
| ether.fi (ETHFI) | `executing` | $382.07M | $5.11M/yr | **74.8×** | speculative |
| Curve Finance (CRV) | `executing` | $371.05M | $7.27M/yr | **51.0×** | speculative |
| Orca (ORCA) | `executing` | $64.87M | $580.92K/yr | **111.7×** | speculative |
| CoW Protocol (COW) | `executing` | $60.72M | $8.30M/yr | **7.3×** | exceptional |
| LayerZero (ZRO) | `executing` | $306.88M | $1.58M/yr | **194.3×** | speculative |
| Synthetix (SNX) | `unverified` | $122.45M | $0/yr | **∞×** | no real capture |
| Usual Money (USUAL) | `executing` | $17.09M | $11.97M/yr | **1.4×** | exceptional |
| pump.fun (PUMP) | `executing` | $1.12B | $202.89M/yr | **5.5×** | exceptional |
| Rollbit (RLB) | `executing` | $110.12M | $0/yr | **∞×** | no real capture |
| Jupiter Exchange (JUP) | `executing` | $605.08M | $22.26M/yr | **27.2×** | fair value |
| Marinade Finance (MNDE) | `executing` | $10.30M | $0/yr | **∞×** | no real capture |
| Lighter (LIT) | `current` | $1.08B | $24.36M/yr | **44.4×** | expensive |
...
| 2 | Current float market cap | $1.28B | 656,132,521 MORPHO × $1.95 (circ source: live) |
...
| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $91.81 | source: live |
| 2 | Current float market cap | $1.42B | 15,422,561 AAVE × $91.81 (circ source: live) |
| 3 | + 24mo unlocks | $0 | No team vesting; 99.9% circulating |
| 4 | + 24mo emissions | +$26.17M | Safety Module + Service Provider compensation (285K AAVE over 24mo) |
...
| 2 | Current float market cap | $188.08M | 1,244,677,493 SYRUP × $0.151109 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: governance_stated) |
| 6 | **Adjusted MCap** | **$188.08M** | Lines 2 + 3 + 4 − 5 |
| 7 | Annual buyback (Category A) | $0 | verification: governance_stated |
...
### Hyperliquid (HYPE) — HM 288.5× _(speculative)_

Phase: `current` — Assistance Fund captures ~99% of revenue for HYPE buybacks. Team vesting cliff active.

| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $54.15 | source: live |
| 2 | Current float market cap | $16.17B | 298,649,468 HYPE × $54.15 (circ source: onchain_feed) |
| 3 | + 24mo unlocks | +$11.28B | Y1 119M + Y2 89.3M team unlocks (Tokenomist scheduled rate) |
| 4 | + 24mo emissions | +$368.22M | Staking emissions paid from Future Emissions allocation (Category C — added to dilution side) |
...
| 6 | **Adjusted MCap** | **$26.58B** | Lines 2 + 3 + 4 − 5 |
...
| 10 | **Holder Multiple (HM)** | **288.5×** | Line 6 ÷ Line 9 |

**Buyback rate lens:** recent 60d annualized = **$92.13M/yr** (HM input). Lifetime annualized (508d, cumulative $919.00M) = **$660.30M/yr**. Recent rate is **-86.0%** below lifetime average.

[Sources: DefiLlama, Hyperliquid Info API, Tokenomist, Hyperliquid docs]

---

### Uniswap (UNI) — HM 41.7× _(expensive)_
...
| 2 | Current float market cap | $2.54B | 624,400,424 UNI × $4.07 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 2 | Current float market cap | $1.24B | 23,390,123,350 SKY × $0.053115 (circ source: live) |
...
| 2 | Current float market cap | $870.79M | 9,828,125,000 ENA × $0.088602 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: governance_stated) |
| 6 | **Adjusted MCap** | **$870.79M** | Lines 2 + 3 + 4 − 5 |
| 7 | Annual buyback (Category A) | $0 | verification: governance_stated |
...
| 2 | Current float market cap | $87.87M | 543,548,924 MET × $0.161655 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: governance_stated) |
...
| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $0.6344 | source: live |
| 2 | Current float market cap | $170.84M | 269,313,892 RAY × $0.634366 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 6 | **Adjusted MCap** | **$170.84M** | Lines 2 + 3 + 4 − 5 |
...
| 2 | Current float market cap | $279.39M | 508,366,806 JTO × $0.549581 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 6 | **Adjusted MCap** | **$279.39M** | Lines 2 + 3 + 4 − 5 |
...
| 2 | Current float market cap | $407.50M | 973,124,001 AERO × $0.418758 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: proxy) |
| 6 | **Adjusted MCap** | **$407.50M** | Lines 2 + 3 + 4 − 5 |
...
| 2 | Current float market cap | $12.86M | 599,013,117 CLOUD × $0.02146486 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: governance_stated) |
...
| 2 | Current float market cap | $94.83M | 5,260,959,219 KMNO × $0.01802535 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: governance_stated) |
| 6 | **Adjusted MCap** | **$94.83M** | Lines 2 + 3 + 4 − 5 |
| 7 | Annual buyback (Category A) | $0 | verification: governance_stated |
...
| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $0.352 | source: live |
| 2 | Current float market cap | $1.71B | 4,869,330,647 ONDO × $0.351978 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: governance_stated) |
...
| 2 | Current float market cap | $266.64M | 1,999,705,628 CARDS × $0.133339 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 6 | **Adjusted MCap** | **$266.64M** | Lines 2 + 3 + 4 − 5 |
...
| 2 | Current float market cap | $0 | 0 DRIFT × $0.01354231 (circ source: seed_fallback) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: governance_stated) |
...
| 2 | Current float market cap | $12.63M | 509,467,624 DOLO × $0.02479909 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: proxy) |
...
### Pendle (PENDLE) — HM 45.1× _(expensive)_
...
| 2 | Current float market cap | $235.75M | 172,079,633 PENDLE × $1.37 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: proxy) |
| 6 | **Adjusted MCap** | **$235.75M** | Lines 2 + 3 + 4 − 5 |
| 7 | Annual buyback (Category A) | $0 | verification: proxy |
| 8 | Annual external cashflow yield to PENDLE (Category B) | $5.23M | fee-share-lockers (executing): 80% of swap fees + all YT yield → vePENDLE. Smart contract enforced, no governance discretion. sPENDLE provides liquid staking alternative. (verification: proxy) |
...
| 2 | Current float market cap | $245.88M | 836,305,815 LDO × $0.294004 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 6 | **Adjusted MCap** | **$245.88M** | Lines 2 + 3 + 4 − 5 |
| 7 | Annual buyback (Category A) | $0 | verification: governance_stated |
...
| 2 | Current float market cap | $66.16M | 10,451,792 GMX × $6.33 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
### dYdX (DYDX) — HM 39.1× _(expensive)_
...
| 2 | Current float market cap | $97.64M | 848,599,091 DYDX × $0.115058 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $0.5288 | source: live |
| 2 | Current float market cap | $12.61M | 23,839,587 GNS × $0.528813 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 2 | Current float market cap | $382.07M | 973,468,000 ETHFI × $0.392479 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 6 | **Adjusted MCap** | **$382.07M** | Lines 2 + 3 + 4 − 5 |
...
### Curve Finance (CRV) — HM 51.0× _(speculative)_
...
| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $0.24 | source: live |
| 2 | Current float market cap | $371.05M | 1,546,239,569 CRV × $0.239968 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: proxy) |
...
### Orca (ORCA) — HM 111.7× _(speculative)_
...
| 2 | Current float market cap | $60.72M | 575,229,467 COW × $0.105565 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 6 | **Adjusted MCap** | **$60.72M** | Lines 2 + 3 + 4 − 5 |
...
### LayerZero (ZRO) — HM 194.3× _(speculative)_
...
| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $0.8686 | source: live |
| 2 | Current float market cap | $306.88M | 353,313,326 ZRO × $0.868583 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 6 | **Adjusted MCap** | **$306.88M** | Lines 2 + 3 + 4 − 5 |
...
| 10 | **Holder Multiple (HM)** | **194.3×** | Line 6 ÷ Line 9 |
...
| 2 | Current float market cap | $122.45M | 580,980,590 SNX × $0.210772 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 2 | Current float market cap | $17.09M | 1,858,355,554 USUAL × $0.00919522 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
| 5 | − 24mo buybacks | $0 |  (verification: proxy) |
...
| 2 | Current float market cap | $1.12B | 393,610,301,177 PUMP × $0.00285499 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 2 | Current float market cap | $110.12M | 1,599,112,931 RLB × $0.068861 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 6 | **Adjusted MCap** | **$110.12M** | Lines 2 + 3 + 4 − 5 |
| 7 | Annual buyback (Category A) | $0 | verification: proxy |
...
| 2 | Current float market cap | $605.08M | 3,320,312,968 JUP × $0.182237 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 6 | **Adjusted MCap** | **$605.08M** | Lines 2 + 3 + 4 − 5 |
| 7 | Annual buyback (Category A) | $22.26M | verification: proxy |
| 8 | Annual external cashflow yield to JUP (Category B) | $0 |  (verification: proxy) |
| 9 | **Total Real Capture** | **$22.26M/yr** | Lines 7 + 8 |
...
| 2 | Current float market cap | $10.30M | 546,399,977 MNDE × $0.01885182 (circ source: live) |
| 3 | + 24mo unlocks | $0 | no editorial schedule — Adj MCap reflects float only |
| 4 | + 24mo emissions | $0 |  |
...
| 7 | Annual buyback (Category A) | $24.36M | last 60d annualized — verification: onchain |
...
| 9 | **Total Real Capture** | **$24.36M/yr** | Lines 7 + 8 |
| 10 | **Holder Multiple (HM)** | **44.4×** | Line 6 ÷ Line 9 |

**Buyback rate lens:** recent 60d annualized = **$24.36M/yr** (HM input). Lifetime annualized (217d, cumulative $24.17M) = **$40.66M/yr**. Recent rate is **-40.1%** below lifetime average.
