...
**Generated:** 2026-05-27T14:35:33.600Z
**As-of:** 2026-05-27
**Mode:** live
...
|---|---|---|---|---|---|
| Sky (SKY) | `phase_1` | $1.59B | $0/yr | **∞×** | no real capture |
| Aave (AAVE) | `current` | $1.25B | $11.64M/yr | **107.5×** | speculative |
| Hyperliquid (HYPE) | `current` | $29.56B | $429.09M/yr | **68.9×** | speculative |
| Lighter (LIT) | `current` | $529.98M | $25.17M/yr | **21.1×** | fair value |
...
| 2 | Current float market cap | $1.59B | 23,244,211,861 SKY × $0.068362 (circ source: live) |
...
### Aave (AAVE) — HM 107.5× _(speculative)_

Phase: `current` — ARFC $30M/yr buyback budget (cut from original $50M). AWW Framework commits 100% product revenue to DAO.

| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $84.78 | source: live |
| 2 | Current float market cap | $1.29B | 15,179,912 AAVE × $84.78 (circ source: live) |
| 3 | + 24mo unlocks | $0 | No team vesting; 99.9% circulating |
| 4 | + 24mo emissions | +$24.16M | Safety Module + Service Provider compensation (285K AAVE over 24mo) |
...
| 10 | **Holder Multiple (HM)** | **107.5×** | Line 6 ÷ Line 9 |
...
### Hyperliquid (HYPE) — HM 68.9× _(speculative)_
...
| 7 | Annual buyback (Category A) | $429.09M | last 60d annualized — verification: onchain |
...
| 9 | **Total Real Capture** | **$429.09M/yr** | Lines 7 + 8 |
| 10 | **Holder Multiple (HM)** | **68.9×** | Line 6 ÷ Line 9 |

**Buyback rate lens:** recent 60d annualized = **$429.09M/yr** (HM input). Lifetime annualized (433d, cumulative $902.00M) = **$760.35M/yr**. Recent rate is **-43.6%** below lifetime average.
