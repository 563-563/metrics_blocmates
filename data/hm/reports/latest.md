...
**Generated:** 2026-05-29T08:54:57.484Z
**As-of:** 2026-05-29
**Mode:** live
...
| Aave (AAVE) | `current` | $1.20B | $10.62M/yr | **112.8×** | speculative |
| Hyperliquid (HYPE) | `current` | $30.97B | $429.62M/yr | **72.1×** | speculative |
| Lighter (LIT) | `current` | $529.98M | $25.40M/yr | **20.9×** | fair value |
...
| 2 | Current float market cap | $1.52B | 23,243,406,330 SKY × $0.06523 (circ source: live) |
...
### Aave (AAVE) — HM 112.8× _(speculative)_

Phase: `current` — ARFC $30M/yr buyback budget (cut from original $50M). AWW Framework commits 100% product revenue to DAO.

| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $81.37 | source: live |
| 2 | Current float market cap | $1.24B | 15,179,912 AAVE × $81.37 (circ source: live) |
| 3 | + 24mo unlocks | $0 | No team vesting; 99.9% circulating |
| 4 | + 24mo emissions | +$23.19M | Safety Module + Service Provider compensation (285K AAVE over 24mo) |
...
| 10 | **Holder Multiple (HM)** | **112.8×** | Line 6 ÷ Line 9 |
...
### Hyperliquid (HYPE) — HM 72.1× _(speculative)_

Phase: `current` — Assistance Fund captures ~99% of revenue for HYPE buybacks. Team vesting cliff active.

| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $62.69 | source: live |
| 2 | Current float market cap | $18.72B | 298,649,468 HYPE × $62.69 (circ source: onchain_feed) |
| 3 | + 24mo unlocks | +$13.06B | Y1 119M + Y2 89.3M team unlocks (Tokenomist scheduled rate) |
| 4 | + 24mo emissions | +$426.29M | Staking emissions paid from Future Emissions allocation (Category C — added to dilution side) |
...
| 6 | **Adjusted MCap** | **$30.97B** | Lines 2 + 3 + 4 − 5 |
| 7 | Annual buyback (Category A) | $429.62M | last 60d annualized — verification: onchain |
...
| 9 | **Total Real Capture** | **$429.62M/yr** | Lines 7 + 8 |
| 10 | **Holder Multiple (HM)** | **72.1×** | Line 6 ÷ Line 9 |

**Buyback rate lens:** recent 60d annualized = **$429.62M/yr** (HM input). Lifetime annualized (435d, cumulative $903.44M) = **$758.06M/yr**. Recent rate is **-43.3%** below lifetime average.

[Sources: DefiLlama, Hyperliquid Info API, Tokenomist, Hyperliquid docs]

---

### Lighter (LIT) — HM 20.9× _(fair value)_
