...
**Generated:** 2026-05-26T18:04:00.066Z
**As-of:** 2026-05-26
**Mode:** live
...
| Aave (AAVE) | `current` | $1.27B | $12.15M/yr | **104.4×** | speculative |
| Hyperliquid (HYPE) | `current` | $30.38B | $431.89M/yr | **70.3×** | speculative |
...
| 2 | Current float market cap | $1.61B | 23,244,725,697 SKY × $0.069263 (circ source: live) |
...
### Aave (AAVE) — HM 104.4× _(speculative)_

Phase: `current` — ARFC $30M/yr buyback budget (cut from original $50M). AWW Framework commits 100% product revenue to DAO.

| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $85.96 | source: live |
| 2 | Current float market cap | $1.30B | 15,179,912 AAVE × $85.96 (circ source: live) |
...
| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $61.54 | source: live |
| 2 | Current float market cap | $18.38B | 298,649,468 HYPE × $61.54 (circ source: onchain_feed) |
| 3 | + 24mo unlocks | +$12.82B | Y1 119M + Y2 89.3M team unlocks (Tokenomist scheduled rate) |
| 4 | + 24mo emissions | +$418.47M | Staking emissions paid from Future Emissions allocation (Category C — added to dilution side) |
...
| 6 | **Adjusted MCap** | **$30.38B** | Lines 2 + 3 + 4 − 5 |
