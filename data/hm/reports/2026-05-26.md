...
**Generated:** 2026-05-26T22:41:27.421Z
**As-of:** 2026-05-26
**Mode:** live
...
| Aave (AAVE) | `current` | $1.27B | $12.15M/yr | **104.2×** | speculative |
| Hyperliquid (HYPE) | `current` | $29.37B | $429.92M/yr | **68.3×** | speculative |
| Lighter (LIT) | `current` | $529.98M | $25.16M/yr | **21.1×** | fair value |
...
| 2 | Current float market cap | $1.61B | 23,244,470,147 SKY × $0.069365 (circ source: live) |
...
### Aave (AAVE) — HM 104.2× _(speculative)_

Phase: `current` — ARFC $30M/yr buyback budget (cut from original $50M). AWW Framework commits 100% product revenue to DAO.

| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $85.77 | source: live |
| 2 | Current float market cap | $1.30B | 15,179,912 AAVE × $85.77 (circ source: live) |
| 3 | + 24mo unlocks | $0 | No team vesting; 99.9% circulating |
| 4 | + 24mo emissions | +$24.44M | Safety Module + Service Provider compensation (285K AAVE over 24mo) |
...
| # | Metric | Value | Notes |
|---|---|---|---|
| 1 | Token price | $59.59 | source: live |
| 2 | Current float market cap | $17.80B | 298,649,468 HYPE × $59.59 (circ source: onchain_feed) |
| 3 | + 24mo unlocks | +$12.41B | Y1 119M + Y2 89.3M team unlocks (Tokenomist scheduled rate) |
| 4 | + 24mo emissions | +$405.21M | Staking emissions paid from Future Emissions allocation (Category C — added to dilution side) |
...
| 6 | **Adjusted MCap** | **$29.37B** | Lines 2 + 3 + 4 − 5 |
| 7 | Annual buyback (Category A) | $429.92M | last 60d annualized — verification: onchain |
...
| 9 | **Total Real Capture** | **$429.92M/yr** | Lines 7 + 8 |
| 10 | **Holder Multiple (HM)** | **68.3×** | Line 6 ÷ Line 9 |

**Buyback rate lens:** recent 60d annualized = **$429.92M/yr** (HM input). Lifetime annualized (432d, cumulative $900.81M) = **$761.10M/yr**. Recent rate is **-43.5%** below lifetime average.
...
| 2 | Current float market cap | $297.50M | 250,000,000 LIT × $1.19 (circ source: live) |
| 3 | + 24mo unlocks | +$257.04M | 54M Y1 + 162M Y2; cliff Dec 22 2026 unlocks 13.5M/mo across 36mo linear |
| 4 | + 24mo emissions | +$26.50M | Staking emissions over 24mo (Category C) |
...
| 6 | **Adjusted MCap** | **$529.98M** | Lines 2 + 3 + 4 − 5 |
